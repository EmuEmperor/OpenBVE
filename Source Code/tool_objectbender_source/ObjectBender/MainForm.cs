...
namespace ObjectBender {
	...
	public partial class MainForm : Form {
		...
		/// <summary>Raised when the Documention link is clicked.</summary>
		/// <param name="sender">The sender.</param>
		/// <param name="e">The event arguments.</param>
		private void LinkDocumentationLinkClicked(object sender, LinkLabelLinkClickedEventArgs e) {
			const string Url = "http://trainsimframework.org/develop/tool_objectbender.html";
			try {
