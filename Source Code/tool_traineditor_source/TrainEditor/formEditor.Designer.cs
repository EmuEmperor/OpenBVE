namespace TrainEditor {
	partial class formEditor {
		...
		private void InitializeComponent() {
			...
			this.panelPane.Controls.Add(this.linkDocumentation);
			...
			// linkDocumentation
			// 
			this.linkDocumentation.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.linkDocumentation.Location = new System.Drawing.Point(8, 408);
			this.linkDocumentation.Name = "linkDocumentation";
			this.linkDocumentation.Size = new System.Drawing.Size(104, 32);
			this.linkDocumentation.TabIndex = 4;
			this.linkDocumentation.TabStop = true;
			this.linkDocumentation.Text = "View documentation...";
			this.linkDocumentation.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.LinkDocumentationLinkClicked);
			// 
			// buttonClose
			// 
